...
public class BaseDao<E extends Serializable> {
	...
	public List<E> sqlListNoCache(String sql, Object... params) throws Exception {
		Class<?> clzz = getEntityClass();
		return dbCenter.sqlListNoCache(clzz.getName(), sql, params);
	}

	public List<Map> sqlListByMap(String sql, Object... params) throws Exception {
		Class<?> clzz = getEntityClass();
		return dbCenter.sqlList(clzz.getName(), sql, params);
	}
