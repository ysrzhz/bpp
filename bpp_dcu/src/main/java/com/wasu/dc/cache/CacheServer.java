...
public abstract class CacheServer
{
  ...
  public abstract void expire(String paramString, int delayTime)
    throws Exception;

  public abstract Long push(String key, String ... values)
    throws Exception;

  public abstract String pop(String key)
    throws Exception;

  public abstract Long queueLen(String key)
    throws Exception;
}
